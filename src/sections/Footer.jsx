    ...
    <footer className="max-container">
        <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
            <div className="flex flex-col items-start">
                ...
                Prepare for the new season with shoes from your local Snefers store. Find your perfect fit and earn rewards                 
                </p>
                <div className="flex items-center gap-5 mt-8 cursor-pointer">
                    {socialMedia.map((icon)=>(
                        <div className="flex justify-center items-center w-12 h-12 bg-white rounded-full hover:bg-[#d5d5d5]" key={icon}>
                          <a href={icon.href}>
                            <img 
                                src={icon.src} 
                                alt={icon.alt}
